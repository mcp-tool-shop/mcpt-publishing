...
### aspire-ai
- **YELLOW** [tagged-not-released] aspire-ai tag v1.0.0 has no GitHub Release

### codebatch
- **GRAY** [missing-homepage] codebatch has no homepage on PyPI
...
| Package | Version | Audience | Issues |
|---------|---------|----------|--------|
| Soundboard.Client | 1.2.2 | front-door | INFO |
| Soundboard.Maui.Audio | 1.0.2 | internal | clean |
| InControl.Core | 1.2.2 | internal | clean |
| InControl.Inference | 1.0.2 | internal | clean |
| Attestia.Core | 1.0.2 | internal | clean |
| Attestia.Client | 1.0.2 | internal | clean |
| Attestia.Sidecar | 1.0.2 | internal | clean |
| Gov.Protocol | 1.0.2 | internal | clean |
| Gov.Common | 1.0.2 | internal | clean |
| CursorAssist.Canon | 1.0.3 | internal | clean |
| CursorAssist.Trace | 1.0.3 | internal | clean |
| CursorAssist.Engine | 1.0.3 | internal | clean |
| CursorAssist.Policy | 1.0.3 | internal | clean |
| MouseTrainer.Domain | 1.1.3 | internal | clean |
...
| CodeTeam | 1.0.2 | front-door | YELLOW |
| CodeTeam.Core | 1.0.2 | internal | clean |
| CodeTeam.Crypto | 1.0.2 | internal | clean |
| CodeTeam.Packaging | 1.0.2 | internal | clean |
| ClaimLedger | 1.0.2 | front-door | clean |
| CreatorLedger | 1.1.2 | front-door | clean |
...
| Package | Version | Audience | Issues |
|---------|---------|----------|--------|
| mcp-tool-shop/mcp-file-forge | ? | undefined | clean |
